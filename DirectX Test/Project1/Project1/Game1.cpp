...
void Game::LoadTextures()
{
 ...
 //
	...
	{
		L"../../Textures/sky.dds",
		L"../../Textures/player.dds",
		L"../../Textures/enemy.dds"
	};
...
void Game::BuildDescriptorHeaps()
{
	...
	auto playerTex = mTextures["playerTex"]->Resource;
	...
	srvDesc.Format = playerTex->GetDesc().Format;
	srvDesc.Texture2D.MipLevels = playerTex->GetDesc().MipLevels;
	md3dDevice->CreateShaderResourceView(playerTex.Get(), &srvDesc, hDescriptor);
...
void Game::BuildMaterials()
{
	...
	player->Name = "player";
	player->MatCBIndex = 1;
	player->DiffuseSrvHeapIndex = 1;
	player->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	player->FresnelR0 = XMFLOAT3(0.1f, 0.1f, 0.1f);
	player->Roughness = 0.1f;

	auto enemy = std::make_unique<Material>();
	enemy->Name = "enemy";
	enemy->MatCBIndex = 2;
	enemy->DiffuseSrvHeapIndex = 2;
	enemy->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	enemy->FresnelR0 = XMFLOAT3(0.1f, 0.1f, 0.1f);
	enemy->Roughness = 0.1f;
